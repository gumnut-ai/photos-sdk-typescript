...
import check_existence_assets from './assets/check-existence-assets';
...
import logout_endpoint_oauth from './oauth/logout-endpoint-oauth';
...
addEndpoint(check_existence_assets);
...
addEndpoint(logout_endpoint_oauth);
