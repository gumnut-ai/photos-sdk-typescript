...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Gumnut)`
    : `const run: (${functionSource.client}: Gumnut) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.assets.downloadThumbnail',
    'client.assets.list',
    'client.assets.retrieve',
    'client.albums.create',
    'client.albums.delete',
    'client.albums.list',
    'client.albums.retrieve',
    'client.albums.update',
    'client.albums.assets.add',
    'client.albums.assets.list',
