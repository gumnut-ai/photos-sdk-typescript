...
import { ClientOptions } from 'gumnut-sdk';
...
export { ClientOptions } from 'gumnut-sdk';
...
export function initMcpServer(params: {
  ...
  const client = new Gumnut(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new Gumnut({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
