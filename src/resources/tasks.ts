...
export type TaskListResponse = Array<TaskListResponse.TaskListResponseItem>;
...
export type TaskListForAssetResponse = Array<TaskListForAssetResponse.TaskListForAssetResponseItem>;

export namespace TaskListForAssetResponse {
  /**
   * A background processing task and its current execution state.
   */
  export interface TaskListForAssetResponseItem {
    /**
     * Unique task identifier with `btask_` prefix
     */
    id: string;
